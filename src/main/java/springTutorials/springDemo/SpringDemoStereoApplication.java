...
@Configuration
@ComponentScan(value="springTutorials.springDemo.SpringStereoType")
public class SpringDemoStereoApplication {

    // just a logger to show what is happening in terminal
    private static Logger LOGGER = LoggerFactory.getLogger(SpringDemoStereoApplication .class);

    public static void main (String [] args){

        AnnotationConfigApplicationContext  applicationContext = new AnnotationConfigApplicationContext(SpringDemoStereoApplication .class);
